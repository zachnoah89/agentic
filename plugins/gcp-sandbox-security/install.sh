...
echo "  python3 mcp/server.py audit examples/sandboxes/overprivileged-agent-platform"
echo "  python3 mcp/server.py validate examples/sandboxes/hardened-cloud-run-reference"
echo "  python3 mcp/server.py recommend examples/sandboxes/overprivileged-agent-platform"
echo ""
